    ...
    <div>
      ...
      <main >
        ...
        <div className="-z-10 fixed inset-0">
          ...
          <div className="absolute bottom-1/4 -right-20 w-[20rem] sm:w-[30rem] lg:w-[40rem] h-[20rem] sm:h-[30rem] lg:h-[40rem] bg-gradient-to-br from-violet-600/30 to-[#f79562]/30 rounded-full blur-3xl animate-float"
