...
export default function Vision() {
  return (
    <section className="relative before:absolute before:inset-0 before:-z-50">
      <div className="mx-auto max-w-6xl sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-5xl pb-16 text-center md:pb-20">
          ...
          {/* Planet */}
          <div className="mb-16 md:mb-20" data-aos="zoom-y-out">
            <div className="text-center max-h-[75vh] overflow-hidden">
              <div className="relative inline-flex rounded-full overflow-visible">
                <div className="pointer-events-none" aria-hidden="true">
                  <img
                    className="absolute -right-64 -top-20 z-20 max-w-none"
                  ...
                  <div>
                    <img
                      className="absolute -left-28 top-16 z-20 animate-[float_4s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-500"
                      src={PlanetTagImg01}
                      width={253}
                      height={56}
                      alt="Tag 01"
                    />
                    <img
                      className="absolute left-56 top-7 z-20 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-30 transition-opacity duration-500"
                      src={PlanetTagImg02}
                      width={241}
                      height={56}
                      alt="Tag 02"
                    />
                    <img
                      className="absolute -left-20 bottom-24 z-20 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-25 transition-opacity duration-500"
                      src={PlanetTagImg03}
                      width={243}
                      height={56}
                      alt="Tag 03"
                    />
                    <img
                      className="absolute bottom-32 left-64 z-20 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-80 transition-opacity duration-500"
                      src={PlanetTagImg04}
                      width={251}
                      height={56}
                      alt="Tag 04"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-zinc-700">
                <svg
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-zinc-700">
                ...
                <span>AI-Human Interaction & Support</span>
              </h3>
