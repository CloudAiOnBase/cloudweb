...
>(({ children, className, ...props }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
      "font-outfit group relative w-auto cursor-pointer overflow-hidden rounded-lg border bg-transparent text-foreground hover:bg-background p-2 px-6 text-center font-semibold transition-all duration-300",
      className,
      )}
      {...props}
