...
const WorkflowCard = ({ imgSrc, altText, label, description }: { imgSrc: string; altText: string; label: string; description: string }) => (
  <a href="#0"
    className="group/card relative h-full overflow-hidden rounded-2xl bg-white shadow-md border border-gray-200 p-px before:pointer-events-none before:absolute before:-left-40 before:-top-40 before:z-10 before:h-80 before:w-80 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:rounded-full before:bg-blue-100/80 before:opacity-0 before:blur-3xl before:transition-opacity before:duration-500 after:pointer-events-none after:absolute after:-left-48 after:-top-48 after:z-30 after:h-64 after:w-64 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:rounded-full after:bg-blue-200 after:opacity-0 after:blur-3xl after:transition-opacity after:duration-500 hover:after:opacity-20 group-hover:before:opacity-100"
  >
    <div className="relative z-20 h-full overflow-hidden rounded-[inherit] after:absolute after:inset-0 after:bg-linear-to-br after:from-blue-50/50 after:via-white/25 after:to-blue-50/50">
      <div
      ...
      <div className="p-6">
        <div className="mb-3"></div>
          <span className="btn-lg relative rounded-full bg-gray-100 px-2.5 py-1.5 text-xs font-normal before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-gray-200/.15),--theme(--color-gray-200/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] hover:bg-gray-200">
            <span className="bg-linear-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">{label}</span>
          </span>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-zinc-800/65">
          ...
          <Spotlight className="group mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3">
            ...
            <WorkflowCard
              imgSrc={WorflowImg02}
              altText="Workflow 02"
              label="AI Agents in Action"
              description="Streamline the product development flow with a content platform that's aligned across specs and insights."
            />
            <WorkflowCard
              imgSrc={WorflowImg03}
              altText="Workflow 03"
              label="CloudVerse Expansion"
              description="Streamline the product development flow with a content platform that's aligned across specs and insights."
            />
          </Spotlight>
        </div>
